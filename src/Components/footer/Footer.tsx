...
const Footer = () => {
  ...
  const isFooterVisible = !hideNavbarRoutes.includes(location.pathname);
  return (
    <>
      {isFooterVisible && (
        <div>
            ...
            <div className="max-w-screen-2xl px-6 sm:px-6 lg:px-12 p-4 py-6 lg:py-8 ">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-500  font-medium">
                      <li className="mb-4">
                        <a
                          href="https://github.com/themesberg/MechkeyPro"
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center ">
                  © 2023{" "}
                  <a href="https://MechkeyPro.com/" className="hover:underline">
                    MechkeyPro™
                  </a>
                  . All Rights Reserved.
                </span>
